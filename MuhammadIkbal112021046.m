...
A = eye (5,5)
%  matrik dengan dimensi 3X3 dengan elemen-elemen semuanya bernilai 0
B = zeros (3,3)
% c. matrik dengan dimensi 4X4 dengan elemen-elemen semuanya bernilai 1
C = ones (4,4)
% d. Matrik dengan dimensi 3x4 dimana elemen-elemen terdistribusi
D = rand (3,4)
